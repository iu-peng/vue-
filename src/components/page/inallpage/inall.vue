...
<script>
	...
	export default {
		...
		created() {
			this.chartData = {
				columns: ['种类', '总数量', '总价', '占比', '比例'],
				rows: [
					{ '种类': '汉堡', '总数量': 1523, '总价': 1523, '占比': 0.12, '比例': 100 },
					{ '种类': '特色小吃', '总数量': 1223, '总价': 1523, '占比': 0.345, '比例': 300 },
					{ '种类': '饮料', '总数量': 2123, '总价': 1523, '占比': 0.7, '比例': 200 },
					{ '种类': '套餐', '总数量': 2123, '总价': 1523, '占比': 0.7, '比例': 200 }
				]
			}
			this.chartSettings = {
				axisSite: { right: ['占比'] },
