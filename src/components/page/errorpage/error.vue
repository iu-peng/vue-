<template>
	<div class="errorbox">
		...
		<div class="col">
		 	<div class="errorbtn" @click="gohome">
		 		<span>←返回首页</span>
		 	</div>
		</div>
		<div class="col">
...
<style>
	.errorbox{
		background: #404853 url(../../../assets/img/errorbg.png);
		overflow: hidden;
	}
	.errorbtn{
		transition: all 0.3s;
	...
	.errorbtn:hover:before {
		transform: translate(-80.9845px,-5px) rotate(270deg);
		background:#f54f59;
		width:2px;
		height:200%;
	}
	.errorbtn:hover:after {
		    transform: translate(133px,5px) rotate(180deg);
